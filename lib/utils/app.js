...
var whitelist = ['http://192.168.86.22:4200', 'http://192.168.86.35:4200'];
var options = {
...
app.use((0, _morgan2.default)(_Env2.default.HTTP_LOG_CONFIG, { stream: _logger2.default.stream })).use(cors(options))
